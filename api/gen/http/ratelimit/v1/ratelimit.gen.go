...
// Valid indicates whether the value is a known member of the BackendProtocol enum.
func (e BackendProtocol) Valid() bool {
	switch e {
	case BackendProtocolEmpty:
		return true
	case BackendProtocolH1:
		return true
	case BackendProtocolH2:
		return true
	case BackendProtocolH3:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the FailurePolicy enum.
func (e FailurePolicy) Valid() bool {
	switch e {
	case FailurePolicyEmpty:
		return true
	case FailurePolicyFailclosed:
		return true
	case FailurePolicyInmemoryFallback:
		return true
	case FailurePolicyPassthrough:
		return true
	default:
		return false
	}
